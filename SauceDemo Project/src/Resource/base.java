...
public class base {
	...
	{
		pro = new Properties();
		FileInputStream file = new FileInputStream("C:\\Users\\Lenovo\\eclipse-workspace\\SauceDemo Project\\src\\Resource\\data.properties");
		pro.load(file);
	...
	public void bordercolor(WebElement element,WebDriver driver)
	{
		JavascriptExecutor js = (JavascriptExecutor) driver;
	...
	public void explicitywait(WebDriver driver,int wait,By element)
	{
